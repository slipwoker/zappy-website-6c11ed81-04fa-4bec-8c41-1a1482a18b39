document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        const errorMessages = {
            ...
            typeMismatch: 'يرجى إدخال قيمة صالحة',
            tooShort: 'القيمة قصيرة جداً',
            patternMismatch: 'يرجى مطابقة التنسيق المطلوب'
        };
        ...
        function validateField(input) {
            ...
            if (input.type === 'email' && input.value.trim()) {
                ...
                if (!emailRegex.test(input.value.trim())) {
                    showError(input, errorMessages.typeMismatch);
                    return false;
                }
            }
            ...
            if (input.hasAttribute('minlength') && input.value.trim()) {
                ...
                if (input.value.trim().length < minLength) {
                    showError(input, errorMessages.tooShort);
                    return false;
                }
            }
            ...
            if (input.hasAttribute('pattern') && input.value.trim()) {
                ...
                if (!pattern.test(input.value.trim())) {
                    showError(input, errorMessages.patternMismatch);
                    return false;
                }
            }
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #28a745; font-size: 1rem; margin-top: 1rem; text-align: center;';
                ...
                .catch(function() {
                    ...
                    errorMessage.style.cssText = 'color: #dc3545; font-size: 1rem; margin-top: 1rem; text-align: center;';
                    errorMessage.textContent = 'حدث خطأ أثناء الإرسال. يرجى المحاولة مرة أخرى';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6c11ed81-04fa-4bec-8c41-1a1482a18b39',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6c11ed81-04fa-4bec-8c41-1a1482a18b39';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6c11ed81-04fa-4bec-8c41-1a1482a18b39';
